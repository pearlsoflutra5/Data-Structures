public class Exercise27point3 {
  ...
  public static void main(String[] args) {
    MyHashMap<Integer, Integer> map = new MyHashMap<>();
        ...
        System.out.println("The age of the runner in 1st Place: " +
          map.get(1));

        System.out.println("Is a runner 33 in the map? " +
          map.containsValue(33));

        System.out.println("Is a runner 31 in the map? " +
